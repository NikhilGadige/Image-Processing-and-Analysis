...
1. Top-left row index of the rectangle (between 0 to 63)
2. Top-left column index of the rectangle (between 0 to 63)
3. Width of the rectangle
4. Height of the rectangle

## Running Instructions

1. Compile the matlab script file "2D_DFT.m"and run the script.
2. When prompted, enter the required inputs:
    - Top-left row index of the rectangle
    - Top-left column index of the rectangle
